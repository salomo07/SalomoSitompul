              ...
              <table id="tblAddBC" class="table table-bordered table-hover dataTable"  width="100%">
                ...
                <tbody style="font-size:12px">
                  <tr>
                    ...
                    <td><center><input type="text" id="txtNamaBarang" placeholder="Nama Barang" class="form-control" disabled></center></td>
                    <td><center><input id="txtSat" type="text" onkeyup="autoCompleteSatuan(this)" placeholder="Satuan" class="form-control" style="width: 80px" disabled></center></td>
...
<script>
  ...
  function warning(element) 
  {
    ...
    else if($('#txttarifBarang').val()==''&& Number($('#txttarifBarang').val())<1)
    {alert('Inputan tarif satuan tidak boleh kosong atau lebih kecil dari 1.');$(element).closest('tr').find('#txtTotal').text('');$(element).closest('tr').find('td').eq(10).find('#txtBM').text('');}
  }
