...
<div class="modal-dialog " style="width: auto;left: 0.0%;">
  <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-12"><br> 
            <div class="col-md-12" style="max-height: 300px"><br>
      ...
      <div class="modal-footer">
        ...
        <button id="btnAddBC" onclick="addRow()" type="button" class="btn" ><i class="fa fa-plus-square"></i>  Add Row</button>
    ...
    else
    {
      ...
      $('#tblAddBC tbody tr').each(function() {
        $(this).find('input:checkbox:checked').each(function() {
          ...
          var Satuan=$(this).closest('tr').find('td').eq(6).find('#txtSat').val();
          var Valas=$(this).closest('tr').find('td').eq(7).find('#txtValas').val();
          var KodeHS=$(this).closest('tr').find('td').eq(8).find('#txtKodeHS').val();
          var Keterangan=$(this).closest('tr').find('td').eq(9).find('#txtKet').val();          
          var Tarif=$(this).closest('tr').find('td').eq(10).find('#txttarifBarang').val();
          var Jumlah=$(this).closest('tr').find('td').eq(11).find('#txtjumlahBarang').val();
          var CIF=$(this).closest('tr').find('td').eq(12).find('#txtCIF').val();          
          var Total=$(this).closest('tr').find('td').eq(13).find('#txtTotal').val();
          var PDRIBayar=$(this).closest('tr').find('td').eq(14).find('#PDRIBayar').val();
          var PDRIBebas=$(this).closest('tr').find('td').eq(15).find('#PDRIBebas').val();
          var NoSkep=$(this).closest('tr').find('td').eq(16).find('#NoSkep').val();
          var TglSkep=$(this).closest('tr').find('td').eq(17).find('#TglSkep').val();
