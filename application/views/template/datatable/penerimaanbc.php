...
<tbody style="font-size:12px">
  <?php foreach ($dataBC as $key => $detail): ?>
    <tr onclick="trClicked(this)"> 
      ...
      <td ><center><?php echo $detail->NoNota;?></td>
      ...
      <td><center><?php if($detail->PDRIBayar!=''){echo number_format($detail->PDRIBayar, 2, ',','.');}?></center></td>
      <td><center><?php if($detail->PDRIBebas!=''){echo number_format($detail->PDRIBebas, 2, ',', '.');}?></center></td>
