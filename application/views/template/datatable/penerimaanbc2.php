...
<tbody style="font-size:12px;">
  ...
  <tr>
    ...
    <td><center><input id="txtTotal" class="form-control txtTotal" type="text" placeholder="Total Nilai Barang" value="<?php if(isset($value->HargaSatuan)&&isset($value->Jumlah)&&$phd==false){echo number_format($value->HargaSatuan*$value->Jumlah, 2, ',', '.');} ?>"></center></td>
